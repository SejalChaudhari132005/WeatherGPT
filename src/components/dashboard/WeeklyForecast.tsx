...
import { WeeklyForecastItem } from '../../data/mockWeather';
  ...
  return (
    <div className="p-3.5 sm:p-5 rounded-2xl sm:rounded-3xl bg-white border border-slate-200/90 shadow-md space-y-3 font-['Arimo']">
      <div className="flex items-center justify-between border-b border-slate-200 pb-2 gap-2">
        ...
        <span className="text-[9px] sm:text-[10px] text-slate-400 font-bold uppercase shrink-0">Extended</span>
      </div>
          ...
          >
            ...
            <div className="flex items-center gap-2 sm:gap-3 shrink-0">
              ...
              <div className="text-right text-xs">
                <span className="font-extrabold text-slate-900">{item.high}°</span>
                <span className="text-slate-400 font-normal ml-1">{item.low}°</span>
              </div>
            </div>
          </div>
        ))}
